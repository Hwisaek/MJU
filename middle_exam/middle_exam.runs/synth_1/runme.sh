...
HD_PWD='C:/Vivado/middle_exam/middle_exam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_ripple_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_ripple_counter.tcl
